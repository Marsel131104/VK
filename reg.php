...
<div class="registration-form">
    ...
    <form method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="password" class="form-control" name="double_password">
        </div>

        <div class="d-grid gap-2" style="margin-top: 30px">
            <button class="btn btn-outline-success" type="button" id="btn">Регистрация</button>
        </div>

        <div ><span id="err" style="font-size: small; color: #ae2012"></span></div>


        <p style="text-align: center; margin-top: 30px"><a href="login.php" class="link-light">Вход</a></p>
    </form>
...
<script src="scripts/reg/script_reg.js"></script>
</body>
</html>
