                ...
                success: function (response) {
                    if (response == "user_create")
                        $("#success_answer").html('<h4 class="alert-heading">Отлично, вы ответили верно!</h4>' +
                            ...
                            '<hr>' +
                            '<p class="mb-0">Теперь можно зайти в <a href="#" class="link-danger link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">конструктор</a> и создать ещё тесты.</p>' +
                            '</div>').show("slow");
